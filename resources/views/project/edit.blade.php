...
{{ Form::model($project, array('route' => array('project.update', $project->id), 'method' => 'PUT', 'class'=> 'form-horizontal')) }}
...
<div class="form-group">
  ...
  <div class="col-sm-10">
    ...
    {{ Form::text('name',null, array('class'=>'form-control', 'id'=>'name', 'placeholder'=>'Enter Project Name') )}}
  </div>
</div>
<!-- <div class="form-group">
...
<div class="form-group">
  ...
  <div class="col-sm-10">
    <!-- <textarea type="text" class="form-control" id="description" placeholder="Enter Description" name="description"></textarea> -->
      {{ Form::text('description',null, array('class'=>'form-control', 'id'=>'description', 'placeholder'=>'Enter Description') )}}
  </div>
</div>
<div class="form-group">
  ...
  <div class="col-sm-10">
    <!-- <textarea type="text" class="form-control" id="remarks" placeholder="Enter Remarks" name="remarks"></textarea> -->
      {{ Form::text('remarks',null, array('class'=>'form-control', 'id'=>'remarks', 'placeholder'=>'Enter Remarks') )}}
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-sm-10">
    ...
    {{ Form::text('budget',null, array('class'=>'form-control', 'id'=>'budget', 'placeholder'=>'Enter Budget Allocated') )}}
  </div>
</div>
      ...
      <div class="col-sm-10">
        ...
        {{ Form::text('expenditure',null, array('class'=>'form-control', 'id'=>'name', 'placeholder'=>'Enter Expenditure') )}}
      </div>
    </div>
            ...
            <option value="External Investor">External Investor</option>
                ...
                <div class="col-sm-10">
                  <!-- <input type="text" class="form-control" id="implementagency" placeholder="Enter Implementing Agency" name="implementagency"> -->
                    {{ Form::text('implementagency',null, array('class'=>'form-control', 'id'=>'implementagency', 'placeholder'=>'Enter Implementing Agency') )}}
                </div>
              </div>
...
<div class="form-group">
  <div class="col-sm-offset-2 col-sm-10">
    ...
    {{ Form::submit('Update project!', array('class' => 'btn btn-info')) }}
  </div>
</div>
<!-- </form> -->
{{ Form::close() }}
